...
(function() {
    var InstaPostInstance = function InstaPostInstance(el) {
        ...
        this.fetchData = function(url) {
            var $this = this;
            fetch("https://api.instagram.com/oembed/?url=" + url, { mode: 'no-cors'}).then(function(response) {
    ...
    var InstaPost = function InstaPost() {
        ...
        this.isElement = function(o) {
            return (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) === "object" ? _instanceof(o, HTMLElement) : o && _typeof(o) === "object" && o !== null && o.nodeType === 1 && typeof o.nodeName === "string"
        }
    };
    window.instapost = {
        instance: undefined,
